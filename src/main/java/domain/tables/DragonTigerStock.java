...
import domain.tables.records.DragonTigerStockRecord;
...
public class DragonTigerStock extends TableImpl<DragonTigerStockRecord> {
    ...
    private static final long serialVersionUID = -836597734;
     ...
     */
    public final TableField<DragonTigerStockRecord, BigDecimal> PCHANGE = createField("pchange", org.jooq.impl.SQLDataType.DECIMAL(10, 4), this, "");

    /**
     * The column <code>tushare.dragon_tiger_stock.amount</code>.
     */
    public final TableField<DragonTigerStockRecord, BigDecimal> AMOUNT = createField("amount", org.jooq.impl.SQLDataType.DECIMAL(15, 2), this, "");

    /**
     * The column <code>tushare.dragon_tiger_stock.buy</code>.
     */
    public final TableField<DragonTigerStockRecord, BigDecimal> BUY = createField("buy", org.jooq.impl.SQLDataType.DECIMAL(15, 2), this, "");

    /**
     * The column <code>tushare.dragon_tiger_stock.sell</code>.
     */
    public final TableField<DragonTigerStockRecord, BigDecimal> SELL = createField("sell", org.jooq.impl.SQLDataType.DECIMAL(15, 2), this, "");
     ...
     */
    public final TableField<DragonTigerStockRecord, BigDecimal> BRATIO = createField("bratio", org.jooq.impl.SQLDataType.DECIMAL(6, 2), this, "");

    /**
     * The column <code>tushare.dragon_tiger_stock.sratio</code>.
     */
    public final TableField<DragonTigerStockRecord, BigDecimal> SRATIO = createField("sratio", org.jooq.impl.SQLDataType.DECIMAL(6, 2), this, "");
     ...
     */
    public final TableField<DragonTigerStockRecord, Integer> COUNT = createField("count", org.jooq.impl.SQLDataType.INTEGER, this, "");

    /**
     * The column <code>tushare.dragon_tiger_stock.probability</code>.
     */
    public final TableField<DragonTigerStockRecord, BigDecimal> PROBABILITY = createField("probability", org.jooq.impl.SQLDataType.DECIMAL(6, 2), this, "");

    /**
     * The column <code>tushare.dragon_tiger_stock.broker_buy</code>.
     */
    public final TableField<DragonTigerStockRecord, BigDecimal> BROKER_BUY = createField("broker_buy", org.jooq.impl.SQLDataType.DECIMAL(15, 2), this, "");

    /**
     * The column <code>tushare.dragon_tiger_stock.broker_buy_prop</code>.
     */
    public final TableField<DragonTigerStockRecord, BigDecimal> BROKER_BUY_PROP = createField("broker_buy_prop", org.jooq.impl.SQLDataType.DECIMAL(6, 2), this, "");

    /**
     * The column <code>tushare.dragon_tiger_stock.broker_sell</code>.
     */
    public final TableField<DragonTigerStockRecord, BigDecimal> BROKER_SELL = createField("broker_sell", org.jooq.impl.SQLDataType.DECIMAL(15, 2), this, "");

    /**
     * The column <code>tushare.dragon_tiger_stock.broker_sell_prop</code>.
     */
    public final TableField<DragonTigerStockRecord, BigDecimal> BROKER_SELL_PROP = createField("broker_sell_prop", org.jooq.impl.SQLDataType.DECIMAL(6, 2), this, "");

    /**
     * The column <code>tushare.dragon_tiger_stock.net</code>.
     */
    public final TableField<DragonTigerStockRecord, BigDecimal> NET = createField("net", org.jooq.impl.SQLDataType.DECIMAL(15, 2), this, "");
