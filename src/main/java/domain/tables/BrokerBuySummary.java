...
import domain.tables.records.BrokerBuySummaryRecord;
...
public class BrokerBuySummary extends TableImpl<BrokerBuySummaryRecord> {
    ...
    private static final long serialVersionUID = -460420165;
     ...
     */
    public final TableField<BrokerBuySummaryRecord, BigDecimal> S_MONEY = createField("s_money", org.jooq.impl.SQLDataType.DECIMAL(10, 4), this, "");

    /**
     * The column <code>tushare.broker_buy_summary.b_money</code>.
     */
    public final TableField<BrokerBuySummaryRecord, BigDecimal> B_MONEY = createField("b_money", org.jooq.impl.SQLDataType.DECIMAL(15, 2), this, "");

    /**
     * The column <code>tushare.broker_buy_summary.jm_money</code>.
     */
    public final TableField<BrokerBuySummaryRecord, BigDecimal> JM_MONEY = createField("jm_money", org.jooq.impl.SQLDataType.DECIMAL(15, 2), this, "");

    /**
     * The column <code>tushare.broker_buy_summary.b_count</code>.
     */
    public final TableField<BrokerBuySummaryRecord, Integer> B_COUNT = createField("b_count", org.jooq.impl.SQLDataType.INTEGER, this, "");

    /**
     * The column <code>tushare.broker_buy_summary.s_Count</code>.
     */
    public final TableField<BrokerBuySummaryRecord, Integer> S_COUNT = createField("s_Count", org.jooq.impl.SQLDataType.INTEGER, this, "");
